...
This tutorial demonstrates how to use the `NatureCubeR` package to interact with the Okala dashboard API.

## Authentication

Your API key is found in your project settings on the Okala dashboard: [https://naturecube.io/api/](https://naturecube.io/api/)
